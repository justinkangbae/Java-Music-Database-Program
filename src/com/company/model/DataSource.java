...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:/Users/Justin Kang Bae/IdeaProjects/Java Course/music/" + DB_NAME;
    ...
    public List<Song> querySongs(int sortOrder) {
        ...
        try (Statement statement = conn.createStatement();
            ...
            while (results.next()) {
                ...
                song.setName(results.getString(INDEX_SONG_TITLE));
